...
for (int cyl = 0;cyl <=550;cyl+= cylSpace){
//Left Cylinder 1
noStroke();
fill(b,r,g,255);
rect(10,10+cyl,cyLength,cyWidth);

//Right Cylinder
noStroke();
fill(r,g,b,255);
rect(560,100+cyl,cyLength,cyWidth);
}
//Left Cylinder 1
//noStroke();
...
for (int t1 =0;t1<=520;t1+=tunSpace){
//Tunnel 1
stroke(wOut1,wOut1,wOut1);
fill(255,204,204);
ellipse(10+t1,50,20,79);
}
/*tunnel 1
stroke(wOut1,wOut1,wOut1);
fill(255,204,204);
